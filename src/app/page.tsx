      ...
      <main className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold text-navy-800 mb-6">
            Samen{" "}
            <span className="text-green-500">buiten</span>{" "}
            zijn
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Ontdek de natuur samen met onze VZW. Word lid en neem deel aan wandelingen, 
            fietstochten en andere buitenactiviteiten in je buurt.
          </p>
        ...
        <div className="max-w-6xl mx-auto mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Activiteiten</h3>
            <p className="text-gray-600">
              Regelmatige wandelingen, fietstochten en andere buitenactiviteiten.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Natuur</h3>
            <p className="text-gray-600">
